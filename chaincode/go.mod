module fabric-samples/2host-test/chaincode-go
...
require (
	...
	github.com/hyperledger/fabric-samples/asset-transfer-basic/chaincode-go v0.0.0-20220323141822-e1fb6269dcea
